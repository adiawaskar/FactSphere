    ...
    <PageLayout className="py-8">
      ...
      >
        ...
        <div className="space-y-8">
          ...
          {/* --- CHANGED: Grid now has 4 columns on large screens --- */}
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {team.map((member, index) => (
              <motion.div
                key={member.name}
                ...
                whileHover={{ scale: 1.05 }}
              >
                {/* --- CHANGED: Card structure to support a vertical image --- */}
                <Card className="glass-card h-full overflow-hidden hover:shadow-lg transition-shadow">
                  {/* Uniformly sized container for the vertical rectangular image */}
