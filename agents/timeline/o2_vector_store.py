...
#         # if results['distances'] and results['distances'][0][0] < (1 - SIMILARITY_THRESHOLD):
#         #      CONSOLE.print(f"[grey50]    - Skipping similar chunk (dist: {results['distances'][0][0]:.4f}).[/grey50]")
#         #      continue

#         distances_for_first_query = results['distances'][0]

#         # First, check if the distances list is NOT empty.
#         if distances_for_first_query:
#             # If it's not empty, get the first (and closest) distance.
#             closest_distance = distances_for_first_query[0]
            
#             # Now, compare with our threshold.
...
#     # Combine metadata and documents into a list of dictionaries
#     all_chunks = []
