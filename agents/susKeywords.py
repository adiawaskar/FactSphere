...
class LLMClient:
    ...
    def get_dynamic_triggers(
        ...
        #     "that appear *directly in the provided text*. "
        #     "Each trigger MUST include a safe regex 'pattern'. "
        #     "Avoid generic everyday words that don't indicate a false narrative, such as 'manufacturing will rise', 'big achievement', or 'good news'."
        #     "Focus on phrases that are characteristic of sensationalism, emotional manipulation, unverified claims, or conspiracy bait. "
        #     "Do not invent phrases — only use what exists in the text. "
...
"Adhere strictly to these instructions without adding any conversational text or commentary."
        ...
        # user_prompt = (
        #     f"TASK: Return ONLY a compact JSON object with up to {max_triggers} triggers.\n"
        #     "Format:\n"
        #     '{ "triggers": [ { "phrase": "...", "pattern": "(?i)\\b...\\b", "category": "...", "notes": "..." } ] }\n\n'
        #     f"Context (title then excerpt):\n"
        #     f"TITLE: {article_title[:300]}\n\n"
        #     f"EXCERPT:\n{article_text[:4000]}\n\n"
        #     "Rules:\n"
        #     "- Extract only phrases that actually occur in the title or excerpt.\n"
        #     "- Prefer multi-word, bait-like phrases.\n"
        #     "- Patterns must be regex-safe and use word boundaries.\n"
        #     "- Categories: clickbait, conspiracy, health-scam, finance, politics, foreign-influence, other.\n"
